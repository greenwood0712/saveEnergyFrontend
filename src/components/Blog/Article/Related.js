  ...
  return (
    <div className="mt-3">
      ...
      <div className="flex flex-wrap w-full">
        ...
        <div className="blog-card md:w-[49%] mr-2 my-2 cursor-pointer">
            <a className="bg-white text-black relative w-full" href="https://www.hpe.com/us/en/insights/articles/a-data-first-strategy-simplifies-data-management-and-protection-2206.html">
                ...
                <div className="p-5 h-60 bg-white">
                    <h1 className="font-bold text-xl">A data-first strategy simplifies data management and protection</h1>
                    <p className="py-3 text-sm font-light">Without data, none of this matters</p>
                </div>
                <div className="indicator absolute bottom-2 px-5 flex w-full">
                    <img src={author1} alt="author" width={30} className="rounded-full" />
        ...
        <div className="blog-card md:w-[49%] mr-2 my-2 cursor-pointer">
            <a className="bg-white text-black relative w-full" href="https://www.hpe.com/us/en/insights/articles/modernize-with-a-cloud-experience-everywhere-2206.html">
                <div className="relative">
                    <div className="h-full">
                    ...
                    <div className="card-tester absolute top-0 left-0 right-0 bottom-0 p-3 text-white bg-black/50 overflow-wrap font-light text-sm">
                        Best of Enterprise.nxt: Modern cloud techniques like cloud-native development enable cloud advantages wherever software runs.
                    </div>
                </div>
                <div className="p-5 h-60 bg-white">
                    <h1 className="font-bold text-xl">Modernize with a cloud experience everywhere</h1>
                    <p className="py-3 text-sm font-light">Improve flexibility, manageability, adaptability</p>
                </div>
                <div className="indicator absolute bottom-2 px-5 flex w-full">
                    <img src={author2} alt="author" width={30} className="rounded-full" />
