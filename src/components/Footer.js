      ...
      <div className="md:flex justify-between items-center py-10 md:px-20">
        <div className="my-5 md:mr-10 md:w-1/2">
          ...
          <div className="mt-10 md:mx-10 flex flex-col justify-center md:flex md:flex-row md:justify-around items-center">
            ...
            <input type="submit" value="Search hpe.com" className="bg-green-500 py-3 px-10 rounded-md hover:bg-green-700 ml-2" />
          </div>
        </div>
        ...
        <div className="md:w-1/2 md:flex justify-around">
          <div className="block md:w-1/2">
            <div className="md:flex justify-start items-center">
              <a href='https://www.hpe.com/us/en/buy-parts-products.html' className="bg-green-500 hover:bg-green-700 md:w-1/2 m-1 h-20 md:h-40 cursor-pointer flex flex-col justify-center items-center">
              ...
              <a href='https://support.hpe.com/hpesc/public/home' className="bg-green-500 hover:bg-green-700 md:w-1/2 m-1 h-20 md:h-40 cursor-pointer flex flex-col justify-center items-center">
                <div className="flex justify-center items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
