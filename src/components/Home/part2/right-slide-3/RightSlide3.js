...
import image1 from "../../../../assets/image (24).jpg";
import image2 from "../../../../assets/image (27).jpg";
import image3 from "../../../../assets/image (28).jpg";
import SlideComponent from "../../SlideComponent";
import data from './data.json'

function RightSlide3() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const images = [image1, image2, image3];
  const components_data = [
    data.map((data, idx) => {
      return <SlideComponent key={idx} color='border-blue-500' title={data.title} text={data.text} link={data.link} button_text={data.button_text} />
    })
  ];
