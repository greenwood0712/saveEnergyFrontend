  ...
  return (
    <div className="flex flex-col justify-center items-center text-center text-white p-20 bg-countdown">
      ...
      <div className="border-2 border-blue-400 p-5 w-fit">
        <p className="text-5xl flex timing"><div className='flex flex-col px-2'><p>12</p><span>D</span></div> <strong>:</strong> <div className='flex flex-col px-2'><p>19</p><span>H</span></div> <strong>:</strong> <div className='flex flex-col px-2'><p>45</p><span>M</span></div> <strong>:</strong> <div className='flex flex-col px-2'><p>12</p><span>S</span></div></p>
      </div>
      ...
      <a href='https://www.hpe.com/us/en/discover.html' className="arrow-animation flex justify-center items-center font-bold w-60 py-3 outline-none outline-offset-0 bg-green-500 hover:outline-2 hover:outline-green-500 rounded-md">
          Learn more&nbsp;&nbsp;
        <svg
